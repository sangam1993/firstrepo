...
public class BaseTest {
	...
	public void placeholder(String xpath, String Expect) {
		String Actual = getElementsoft(xpath).getAttribute("placeholder");
		if (Actual.equals(Expect)) {
			test.log(LogStatus.PASS, Expect + " " + "Placeholder value is verified ");
		} else {
			test.log(LogStatus.FAIL, Expect + " " + "Placeholder value is not Correct");
		}
	}
	/***************** reporting ****************/
